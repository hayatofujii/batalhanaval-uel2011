...
public class ConfigConexao extends JPanel {
    ...
    PainelConexao form;
    JLabel batalha, redes, andre, hayato, paulo;
    ...
    public ConfigConexao() {
        ...
        form.setBounds(300, 205, tamConexao.width, tamConexao.height);
        add(form);
        ...
        batalha.setBounds(288, 33, tamBatalha.width, tamBatalha.height);
        add(batalha);
        ...
        redes.setBounds(322, 80, tamRedes.width, tamRedes.height);
        add(redes);
        ...
        paulo.setBounds(326, 160, tamPaulo.width, tamPaulo.height);
        add(paulo);
    }
}